...
def main():
    ...
    for instrument in instruments:
        ...
        #changeInPrice
        stock[instrument] = stock[instrument].join(
            pd.Series(change_in_price(stock[instrument]['Close'].values), name="Change In Price")
        )
        ...
        df_instrument=df_instrument[['Price','Change In Price','Divergence Factor 1', 'Divergence Factor 2', 'Divergence Factor 3', 'Divergence Factor 4',
